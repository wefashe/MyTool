...
button1 = tk.Button(win, text="点击tk按钮",  command=lambda:print_tk_text('tk按钮被点击了')) # 创建按钮
button1.pack(pady=10) # 按钮添加到窗口
button2 = ttk.Button(win, text="点击ttk按钮",  command=lambda:print_tk_text('ttk按钮被点击了')) # 创建按钮
...
win.iconbitmap('favicon.ico') # 设置图标
win.title('测试窗口') # 标题
win.mainloop() # 进入消息循环