...
class Win(Tk):
    def __init__(self):
        ...
        self.tk_input_register_code,self.tk_var_register_code,irc_x_pos,irc_y_pos = self.__tk_input_register_code(self, y_pos = 70)
        self.tk_button_register_code,brc_x_pos,brc_y_pos = self.__tk_button_register_code(self,x_pos=imc_x_pos + 5, y_pos = 70)
...
class WinGUI(Win):
    ...
    def __event_bind(self):
        ...
        self.tk_button_register_code.bind('<Button-1>',lambda event: self.ctl.paste_from_clipboard(event, self.tk_input_register_code))
